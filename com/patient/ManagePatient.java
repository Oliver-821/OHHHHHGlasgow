...
public class ManagePatient extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
		...
		sex.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "male",
				"female" }));
		//医生
	...
	private void uptbuttonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if(flag){
			JOptionPane.showMessageDialog(this, "Modify patient information successfully");
			this.dispose();
			desktop.removeAll();
			...
			JOptionPane.showMessageDialog(this, "Modify patient information failed");
		}
	}
...
//删除病人住院信息
	private void deletebuttonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		int yes = JOptionPane.showConfirmDialog(null,  r + "'Is this patient confirmed to be discharged?？");
		if (yes == 0) {
			//设置相应的床位信息
			BedModel bmodel = new BedModel();
			Bed b = new Bed();
			...
			if (flag) {
				JOptionPane.showMessageDialog(this, "Congratulations on your discharge and good health!");
				desktop.removeAll();
				PatientTableFrame tableframe = new PatientTableFrame();
				desktop.add(tableframe);
				tableframe.setVisible(true);
...
//查找某病人
	private void searchbuttonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if(p.getName()==null){
			JOptionPane.showMessageDialog(this, "No information on this patient");
			return;
		}
	...
	private void addbuttonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if(flag){
			...
			JOptionPane.showMessageDialog(this, "Add patient residence information successfully");
			this.dispose();
			desktop.removeAll();
			PatientTableFrame tableframe = new PatientTableFrame();
			desktop.add(tableframe);
			...
			JOptionPane.showMessageDialog(this, "Add patient residence information failed");
		}
	}
